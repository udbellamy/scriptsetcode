...
StrFileLog = objShell.CurrentDirectory & "\_report_mem_MediaContactGateway.txt"

'liste des process to Check
ProcesstoWatch = "McGateway.exe"
...
ElseIf critCount > 800 Then
	exitState = intWarning
Else
	exitState = intOK
End If

Wscript.echo "MediaContact Gateway Memory usage : " & CInt(CritCount) & " Mo | used=" & CritCount
