...
' Queues to monitor
Dim toMonitor(5)
toMonitor(0) = "avlfaileddatainsert,500,900"
toMonitor(1) = "udpserverinvalidmessagequeue,500,900"
toMonitor(2) = "udpserverinvalidmobilemessagequeue,500,900"
toMonitor(3) = "unkownaliasqueue,500,900"
toMonitor(4) = "sms_send,500,900"
toMonitor(5) = "email_send,500,900"
